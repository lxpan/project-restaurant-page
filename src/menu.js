...
export default function loadMenu(parent) {
    ...
    const menuBurger = createMenuItem('Burger-In-A-Can', "It's a burger! It's a can! No, it's a Burger-In-A-Can! Why settle for the real thing when you can settle for the next best thing!", '$2', burger);
